    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 id="here">The Following Jobs Were Added By You:-</h1>
...
while($results=mysql_fetch_array($query)){
	echo "<script>
	   ...
	   document.getElementById('$results[0]').innerHTML='JOB :<a href=teditjobss.php?c=$results[0]> $results[1]</a><hr>';
	   </script>";
	   $_SESSION['d']=$results[0];
}
?>