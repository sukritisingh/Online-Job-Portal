...
if(isset($_POST['submit2'])){
	if($_SESSION['random']==$_POST['otp']){
		...
		$res = mysql_query($sql);
		$sql1="SELECT * FROM employee where Email='$username' AND Password='$password'";
...
<body id="cont"><body>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="tjseeker.php">JOB-SEEKER SIGN-UP</a>
                </li>
                <li>
  ...
  <legend align="middle"></legend>
      ...
      <div class="col-lg-10">
        <input class="form-control" id="top" name="otp" placeholder="" type="number" >
      </div>
    </div>
	<div class="form-group">
