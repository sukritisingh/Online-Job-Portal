    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 id='here'>The Following are The Recieved Applications:-</h1>
...
while($results=mysql_fetch_array($query)){
	   ...
	   document.getElementById('$results[0]').innerHTML='JOB : $results[1]<br> <a href=tjobs.php?a=$results[0]>click here to see the recieved  applications</a> <hr>';
	   </script>";
	}
